			...
			<nav class="navbar bg-secondary navbar-dark">
				...
				<div class="navbar-nav w-100">
					<a href="BlackSpot.html" class="nav-item nav-link"><i
						...
						href="ZReport.jsp" class="nav-item nav-link active"><i
						class="fa fa-table me-2"></i>View Zone Report</a>
		...
		<div class="content">
			...
			<div class="col-12">
				<div class="bg-secondary rounded h-100 p-4">
					<h6 class="mb-4">Yellow Zone Report Table</h6>
					<div class="table-responsive">
						<table class="table">
							...
							try {
								...
								PreparedStatement ps = con.prepareStatement("select * from addspot where zone='Yellow' ");
								// ps.setString(1, rsn);
						...
						<div class="col-12">
							<div class="bg-secondary rounded h-100 p-4">
								<h6 class="mb-4">Orange Zone Report Table</h6>
								<div class="table-responsive">
									<table class="table">
										...
										try {
											...
											//String rsn=request.getParameter("zone");	 
											Connection con = ConnectDB.getConnect();
											PreparedStatement ps = con.prepareStatement("select * from addspot where zone='Orange' ");
											// ps.setString(1, rsn);
											ResultSet rs = ps.executeQuery();
											while (rs.next()) {
										%>
									...
									<div class="col-12">
										<div class="bg-secondary rounded h-100 p-4">
											<h6 class="mb-4">Red Zone Report Table</h6>
											<div class="table-responsive">
												<table class="table">
													...
													try {
														...
														//String rsn=request.getParameter("zone");	 
														Connection con = ConnectDB.getConnect();
														PreparedStatement ps = con.prepareStatement("select * from addspot where zone='Red' ");
														// ps.setString(1, rsn);
														ResultSet rs = ps.executeQuery();
														while (rs.next()) {
													%>
